  ...
  return (
    <div className="flex items-center justify-center h-screen bg-gray-100">
      ...
      <span className={` text-2xl md:text-4xl flex justify-center items-center py-8 font-mono font-extrabold  ${poller_one.className} text-zinc-200`}>
        ...
        <h1 className=" text-zinc-100 text-2xl font-bold">Create Company Profile</h1>
        <form onSubmit={handleSubmit(onSubmit)} className="py-4 space-y-6">
          ...
          <input
            ...
            className="w-full p-2 border border-gray-300 rounded"
          />
          {errors.adminEmail && <span className="text-red-500">Admin Email is required</span>}
          <input
            ...
            className="w-full p-2 border border-gray-300 rounded"
          />
          {errors.adminPassword && <span className="text-red-500">Admin Password is required</span>}
          <button
            type="submit"
